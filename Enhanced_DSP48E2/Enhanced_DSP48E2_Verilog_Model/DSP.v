...
// Configurations	
	...
	wire configuration_output_from_multiplier_stream_in;
...
*******************************************************/
   ...
   .input_freezed (0)
	...
	D_Register_block_RegOut   # (
   .input_freezed (1'b0)
)					D_Register_block_inst(
		.clk(clk),
...
*					- wide_xor_block
*******************************************************/
multiplier_stream_in multiplier_stream_in_inst(
.   clk              (clk),
.   MULTMODE_out     (MULTMODE_out),
.   configuration_input(configuration_output_from_inmode_manager_block_inst),
.   configuration_enable(configuration_enable),
.   configuration_output(configuration_output_from_multiplier_stream_in)
); 
	Multiplier_xilinx 			Multiplier_xilinx_inst (
		.clk(clk),
		.reset(RSTM),
		.mode_control(MULTMODE_out) ,
		.a(A_MULT),
		.b({DG,B_MULT}),
		.result1(M_temp[47:0]),
	...
	multiplier_output_manager 			multiplier_output_manager_inst (
		...
		.M(M),
		.configuration_input(configuration_output_from_multiplier_stream_in),
		.configuration_enable(configuration_enable),
